...
//Funktion för begära datahämtningen av slott från SMAPI i Kalmar, och samtidigt koppla Google maps till förfrågningen av datan.
function requestData2() {
  let request2 = new XMLHttpRequest();
  request2.open("GET", "https://smapi.lnu.se/api/?api_key=" + APIkey + "&debug=true&controller=establishment&method=getAll&descriptions=slott&counties=kalmar län");
  request2.send(null);
...
//Funktion för begära datahämtningen av konsthallar från SMAPI i Kalmar, och samtidigt koppla Google maps till förfrågningen av datan.

function requestData5() {
  let request5 = new XMLHttpRequest();
  request5.open("GET", "https://smapi.lnu.se/api/?api_key=" + APIkey + "&debug=true&controller=establishment&method=getAll&descriptions=konsthall&counties=kalmar län");
  request5.send(null);
