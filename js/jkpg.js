...
//Funktion för begära datahämtningen av museum från SMAPI i Jönköping, och samtidigt koppla Google maps till förfrågningen av datan.
...
//Funktion för begära datahämtningen av slott från SMAPI i Jönköping, och samtidigt koppla Google maps till förfrågningen av datan.
function requestData2() {
 ...
 //Funktion för begära datahämtningen av kyrkor från SMAPI i Jönköping, och samtidigt koppla Google maps till förfrågningen av datan.
 ...
 //Funktion för begära datahämtningen av sevärdheter från SMAPI i Jönköping, och samtidigt koppla Google maps till förfrågningen av datan.
 ...
 //Funktion för begära datahämtningen av konsthallar från SMAPI i Jönköping, och samtidigt koppla Google maps till förfrågningen av datan.
...
function getData(items) {
 ...
 // Kod för att elementen ska vara tomma innan datan efterfrågats, och om data existerar i elementen ska den tömmas vid ny förfrågan av data.
